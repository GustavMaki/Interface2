...
namespace ProductManagement.Windows.UI
{
    class LocalStorage : IRepository
    {
        ...
        public LocalStorage()
        {
            ...
            products.Add(new Product() { Name = "Gafflar 10x", Price = 100 });
            products.Add(new Product() { Name = "Stekpanna", Price = 150 });
            products.Add(new Product() { Name = "Kastrullset", Price = 100 });
        }
